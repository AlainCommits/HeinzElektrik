...
export async function generateMetadata({ params }: { params: { city: string } }): Promise<Metadata> {
  ...
  return {
    title: `Elektriker Notdienst ${cityData.name} | 24/7 Elektro-Service`,
    description: `24h Elektriker Notdienst in ${cityData.name}. ✓ Festpreise ✓ Qualifizierte Mitarbeiter ✓ In 15 Min vor Ort ➤ Jetzt anrufen!`,
  }
}
